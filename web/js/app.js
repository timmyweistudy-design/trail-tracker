...
$("#btnDiag").addEventListener("click", async () => {
  ...
  const L = [
    ...
    "帳號 " + login + " " + pro,
    "小隊 " + g(() => { if (typeof TeamLive === "undefined" || !TeamLive.status) return "模組未載"; const s = TeamLive.status(); return s.on ? ("連線 " + (s.sub || "?") + " · conn " + s.conn + "/drop " + s.drop + " · presence " + s.presence + " · 隊長" + (s.leader ? "有" : "無")) : "未連線"; }),
