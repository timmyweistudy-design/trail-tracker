...
const I18n = (() => {
  const DICT = {
    ...
    // 情境式導覽（詳情／小隊／社群／記錄）
    "步道資訊": "Trail info",
    "與小隊同行": "Live with team",
    "搜尋山友": "Find hikers",
    "我的檔案": "My profile",
    "記錄地圖": "Tracking map",
    "知道了": "Got it",
    "上面這排可以快速跳到各區：天氣、海拔、生態、景點、美食。": "This row jumps you to each section: weather, elevation, wildlife, sights and food.",
    "顯示步道所在地的即時天氣與未來預報，出發前先看一下。": "Shows live weather and the forecast for the trail's location — check it before you head out.",
    "沿路的高度變化圖，幫你評估上坡有多硬、要爬多高。": "An elevation chart along the route, so you can gauge how steep and how high the climb is.",
    "這條步道常見的動植物，還能查 iNaturalist 附近的真實目擊。": "Plants and animals often seen on this trail; you can also check real iNaturalist sightings nearby.",
    "分享步道、揪團出遊、加入比較、開啟導航，都在這一排。": "Share the trail, plan a group hike, add to compare, or open navigation — all in this row.",
    "山區常常沒有訊號，先在這裡把地圖下載起來就不怕迷路。": "Mountains often have no signal; download the map here so you won't lose your way.",
    "準備好了嗎？從這條步道直接開始記錄你的足跡吧！": "Ready? Start recording your hike straight from this trail!",
    "和山友組隊，在記錄地圖上即時看到彼此的位置，一起安全同行。": "Team up with hikers and see each other's live location on the tracking map — hike together safely.",
    "取個隊名按「建立」，系統會給你一組加入碼，分享給隊友。": "Name your team and tap Create; you'll get a join code to share with teammates.",
    "拿到隊友的加入碼？輸入後按「加入」，就成為小隊的一員。": "Got a teammate's join code? Enter it and tap Join to become part of the team.",
    "打開後，隊員在記錄頁的地圖上就能看到彼此的即時定位。": "Turn it on and teammates can see each other's live location on the record-page map.",
    "看你追蹤的山友發的貼文，可以按讚、留言，或收藏他們的路線。": "See posts from hikers you follow; like, comment, or save their routes.",
    "探索其他山友公開的健行足跡與旅程，替下次出遊找靈感。": "Explore other hikers' public tracks and trips to get ideas for your next outing.",
    "用名稱或 @帳號找到山友，追蹤他們就能在動態看到更新。": "Find hikers by name or @handle; follow them to see updates in your feed.",
    "有人按讚、留言、追蹤你，或小隊邀請，都會出現在這裡。": "Likes, comments, new followers and team invites all show up here.",
    "你的個人檔案、發過的貼文和追蹤名單，也能在這裡編輯資料。": "Your profile, your posts and follow lists — you can also edit your details here.",
    "開始後，地圖會即時畫出你走過的軌跡，鎖螢幕、沒訊號也照記。": "Once started, the map draws your track live — it keeps recording even when locked or offline.",
    "出發時按「開始」，結束按「結束」就會存成一筆健行紀錄。": "Tap Start when you set off and Finish when you're done to save it as a hike.",
    "跳過導覽": "Skip tour",
    ...
    "PRO 徽章、頭像框、名字跟色、專屬主題、夥伴命名與裝扮、PRO 表情貼": "PRO badge, avatar frame, name color, themes, buddy naming & dress-up, PRO reactions", "夥伴命名·裝扮 / 頭像框": "Buddy naming & dress-up / avatar frame",
    ...
    "鳥類": "Birds",
    "昆蟲": "Insects",
    "兩棲爬蟲": "Amphibians & reptiles",
    "小黑蚊・蚊蟲": "Biting midges & mosquitoes",
    "風險高": "High risk",
    "風險中": "Moderate risk",
    "風險低": "Low risk",
    "幾乎無": "Almost none",
    "這個海拔帶常會遇到的（非本步道實際紀錄）": "Commonly seen at this elevation (not records from this trail)",
    "穿長袖長褲、擦防蚊液（含敵避 DEET 或 Picaridin）": "Wear long sleeves and trousers; use repellent (DEET or picaridin)",
    "小黑蚊白天叮咬，10–15 時最兇": "Midges bite by day — worst 10:00–15:00",
    "避免在竹林、樹蔭下久坐": "Avoid sitting for long in bamboo groves or shade",
    "偶有蚊蟲，視情況簡單防護即可": "Occasional insects — basic protection is enough",
    "目前風險低，仍建議基本防蚊": "Low risk right now, but basic repellent is still advised",
    "目前非小黑蚊活躍季（3–11 月），風險低": "Outside midge season (Mar–Nov) — low risk",
    "海拔高，小黑蚊幾乎絕跡，一般蚊蟲也少": "Too high for midges; few biting insects overall",
    "看這附近的真實目擊": "See real sightings nearby",
    "需要網路才能看真實目擊": "Internet required to show real sightings",
    "查詢附近目擊中…": "Loading nearby sightings…",
    "iNaturalist 附近 5 公里的真實觀察": "Real observations within 5 km (iNaturalist)",
    "這附近暫時沒有可顯示的目擊記錄": "No sightings to show near here right now",
    "最近搜尋": "Recent",
    ...
    "回復購買": "Restore purchase", "回復購買中…": "Restoring…", "找不到可回復的購買": "No purchase to restore", "款項處理中，稍後自動生效": "Payment processing — it will activate shortly", "已購買但同步中，請稍後或重開 App": "Purchased — syncing. Please wait a moment or reopen the app", "購買失敗，請稍後再試": "Purchase failed, please try again",
    "坡度": "Grade",
    ...
    "自由路線，按「開始」記錄路徑": "Free route — tap Start to record",
    ...
    "進階數據": "Advanced metrics",
    "路線檔匯入匯出": "GPX import & export",
    ...
    "📡 GPS 訊號較弱，走到空曠處收訊會更準": "📡 Weak GPS signal — move to an open area for better accuracy",
    "附近其他步道": "Other trails nearby",
    "🔥 熱門": "🔥 Popular", "👣 最近走過": "👣 Recently walked",
    ...
    "已自動開啟小隊同行": "Team Live auto-enabled",
    // ── 社群 ──
  ...
  const LANGS = { en: { D: DICT, P: PATTERNS } };
  ...
  // 確保某語言的字典/規則已載入（en 內建；其餘按需抓 web/js/i18n/<code>.js）
  function ensureLang(l, cb) {
    if (l === "en" || l === "zh" || LANGS[l]) return cb();
    try {
  ...
  return { lang, set, start, walk, tx, registerLang, tables: () => LANGS };
})();
