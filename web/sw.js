// 離線快取：app shell + 地圖圖磚
const CACHE = "trail-tracker-v394";
...
const ASSETS = [
  ...
  "./js/photos.js", "./js/amenities.js", "./js/food.js", "./js/attractions.js", "./js/weather.js", "./js/profile.js", "./js/recorder.js", "./js/elevation.js", "./js/offline.js", "./js/gpx.js", "./js/iap.js", "./js/premium.js", "./js/pet.js", "./js/analytics.js", "./js/ecology-data.js", "./js/ecology.js", "./js/app.js",
...
self.addEventListener("fetch", e => {
  ...
  if (url.includes("server.arcgisonline.com") || url.includes("tile.opentopomap.org") || url.includes("tile.openstreetmap") || url.includes("elevation-tiles-prod") || url.includes("wmts.nlsc.gov.tw") || url.includes("tile.happyman.idv.tw")) {
    e.respondWith(
