// 離線快取：app shell + 地圖圖磚
const CACHE = "trail-tracker-v222";
const TILE_CACHE = "tt-tiles";   // 地圖圖磚（不隨版本清除，保留離線地圖）
const ASSETS = [
  "./", "./index.html",
  "./css/style.css",
  "./js/trails-data.js", "./js/trails-detail.js", "./js/trails-geo.js", "./js/storage.js", "./js/i18n.js", "./js/grades.js", "./js/config.js", "./js/conditions.js",
